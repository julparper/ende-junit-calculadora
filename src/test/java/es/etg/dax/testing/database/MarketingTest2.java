...
public class MarketingTest2 {
    ...
    //Ahora realizamos una prueba de forma convencional usandola implemtación real de OfertaDAO (OfertaDAOImpl)
    @Test
    public void contratarReal() throws Exception{
        ...
        @Test
    public void contratarRealCambiado() throws Exception{
        
        //Ahora le decimos a Mockito que tiene que devolver en el caso de que llamen a cada mock. En este caso le decimos que cuando llamen a cada mock, devuelva 1
        Mockito.when(clientesDAO.insert(any())).thenReturn(1);

        Cliente cliente = new Cliente ("María", "García"); 
        doReturn(99).when(ofertaDAO).insertar(cliente); // Cuando se llame a insertar de OfertaDAOImpl con Maria Garcia, devolverá 99
